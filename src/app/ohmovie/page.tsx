          ...
          <Sidebar>
            <SidebarCard>
              ...
              <SidebarItem>
                ...
                <SidebarItemValue>Movie Platform</SidebarItemValue>
              </SidebarItem>
              <SidebarItem>
            ...
            <SidebarCard>
              ...
              <RelatedProjectsList>
                ...
                <RelatedProject>
                  <RelatedProjectLink href="/portfolio">
                    <RelatedProjectTitle>Portfolio</RelatedProjectTitle>
                    <RelatedProjectDesc>개인 프로젝트 포트폴리오</RelatedProjectDesc>
                  </RelatedProjectLink>
                </RelatedProject>
              </RelatedProjectsList>
            </SidebarCard>
...
const ProjectHero = styled.section<{ $backgroundImage?: string }>`
  ...
  min-height: 400px;
  position: relative;
  background-image: ${props => props.$backgroundImage ? `url(${props.$backgroundImage})` : 'linear-gradient(135deg, #f87171 0%, #ef4444 100%)'};
